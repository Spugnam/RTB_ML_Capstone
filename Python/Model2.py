"""
original file https://kaggle2.blob.core.windows.net/forum-message-attachments/58054/1753/fast_solution_v3.py
"""
...
# A, paths
train = '../data/old/train.csv'               # path to training file
test = '../data/old/test.csv'                 # path to testing file
submission = str(datetime.now()).split(".")[0] + '_predictions_v2.csv'  # path of to be outputted submission file
        ...
        if self.interaction:
            ...
            for i in xrange(L):
                for j in xrange(i+1, L):
                    ...
                    yield abs(mmh3.hash(str(x[i]) + '_' + str(x[j]))) % D
...
len(learner.z) - learner.z.count(0)
